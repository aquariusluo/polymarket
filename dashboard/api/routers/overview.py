...
def get_overview(conn: sqlite3.Connection = Depends(get_db)):
    ...
    return {
        ...
        'signal_rejection_reasons': summary.get('signal_rejection_reasons', {}),
        'execution_rejection_reasons': summary.get('execution_rejection_reasons', {}),
        'execution_suppression_reasons': summary.get('execution_suppression_reasons', {}),
